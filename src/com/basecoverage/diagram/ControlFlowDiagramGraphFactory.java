package com.basecoverage.diagram;
...
public class ControlFlowDiagramGraphFactory 
{
	 ...
	 * @return diagram
	 */
	public static ControlFlowGraphDiagram createSourceCodeGraphDiagram(
...
//				r = new BasicBlockVertex();
	 ...
	 */
	public static ControlFlowGraphDiagram buildSourceControlFlowDiagram(String[] classPath, 
																		String packageName, 
																		String className,
																		String methodName, 
																		String methodSig, 
																		String fileName) throws ControlFlowGraphException, IOException 
	{
		/* get preferences */
		...
		IDirectedGraphExt graph = generateSourceCodeGraph(classPath,
														  packageName, 
														  className,						
														  methodName, 
														  methodSig, 
...
//			}
																		...
																		LineNumberTableEntry[] lineNumberTable) throws ControlFlowGraphException, IOException 
	{
		...
		/* generate control flow graph */
		IDirectedGraphExt graph = generateSourceCodeGraph(instructions, 
														  lineNumberTable,
														  createStartNode, 
														  createExitNode, 
														  createBackEdge);
	...
	protected ControlFlowGraphDiagram createDiagram( String[] classPath, String mPackage, String mClassName, String mMethodName, String mMethodSignature){
		...
		try {
			controlFlowGraphDiagram = ControlFlowDiagramGraphFactory.buildBasicblockGraphDiagram(classPath, mPackage, mClassName, mMethodName, mMethodSignature);
...
//			Messages.error(e.getMessage() + CoreMessages.ExceptionAdditionalMessage);
	...
	public static ControlFlowGraphDiagram buildBasicblockGraphDiagram(
		...
		/* generate control flow graph */
		IDirectedGraphExt basicBlockGraph = generateBasicBlockGraph(instructions, null, createStartNode,
	...
	public static ControlFlowGraphDiagram buildBasicblockGraphDiagram(
		...
		/* generate control flow graph */
		IDirectedGraphExt basicBlockGraph = generateBasicBlockGraph(classPath, packageName, className,
	...
	{
		FilteringCodeVisitor codeVisitor = getInstructionList(classPath, packageName, className, methodName, methodSig);
		return generateBasicBlockGraph(codeVisitor.getInstructions(), codeVisitor.getLineNumberTable(), createStartVertex, createExitvertex, createBackEdge);
	}
